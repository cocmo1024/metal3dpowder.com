...
That makes H13 easier to justify for tooling that is actually punished by heat. The more the failure mode is driven by hot-service behavior, the more likely H13 is the better first answer.
