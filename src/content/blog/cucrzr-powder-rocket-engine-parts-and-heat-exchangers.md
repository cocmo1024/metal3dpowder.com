...
| Preburner, injector, igniter, or support hardware | Part-specific hot-gas, pressure, corrosion, and structural duty | IN718, IN625, Alloy X, NASA-developed alloys, or another qualified route | LPBF or DED depending on size and geometry | Select from the actual failure mode, not from the word "rocket" |
