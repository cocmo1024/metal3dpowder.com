...
description: Practical LPBF powder particle size guidance covering common PSD windows, why they differ, and what buyers should specify in a quote request.
pubDate: 2026-04-12
category: Process
tags:
  - LPBF
...
Particle size is one of the first things buyers ask about in an LPBF powder RFQ, and that makes sense. It affects recoating behavior, layer consistency, flow, apparent density, and how comfortably the powder fits a known process window.
...
Many LPBF buyers recognize ranges like 15-45 um or 15-53 um because they are common in commercial powder offers. Those ranges tend to balance flow behavior and fine-feature capability reasonably well for many alloys and machines.
...
For purchasing purposes, PSD should be reviewed together with:
...
Fine, reactive, high-value powders such as titanium and nickel are usually handled more conservatively than buyers expect. Aluminum brings its own handling issues. Stainless powders often feel more forgiving, but that should not lead to a loose specification.
...
If the team already has a validated powder window, the best RFQ is the simplest one: ask for that exact PSD and state the process route clearly.

If the team is still deciding, the RFQ should at least define:

- alloy grade
- LPBF process route
- whether the request is for development or qualification
- whether reused powder is part of the plan
- any machine or layer-thickness constraints already known

That gives the supplier enough context to quote a realistic cut rather than a generic one.

## Why the cheapest PSD offer can be risky

Two offers can both say "15-45 um" and still describe very different commercial realities. One may come with stronger control of fines, tighter morphology consistency, or better lot traceability. Another may only satisfy the nominal size range.
