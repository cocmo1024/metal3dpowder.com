...
If the end use is really aerospace structural hardware rather than titanium AM in general, continue with the application-specific [Ti64 aerospace structures guide](/posts/Alloys/ti64-titanium-powder-aerospace-structures/). If the titanium part is specifically an aircraft hydraulic manifold or valve block, continue with the narrower [Ti64 aircraft hydraulic page](/posts/Alloys/ti64-powder-aircraft-hydraulic-manifolds-and-valve-blocks/). If the titanium route is being defined for orthopedic or medical use, continue with the focused [Ti64 Grade 23 medical applications page](/posts/Alloys/ti64-grade-23-powder-orthopedic-implants-and-medical-components/).
