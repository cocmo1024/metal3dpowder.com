...
export const productFamilies: Array<{
...
}> = [
  {
    id: 'titanium',
    label: 'Titanium',
    description: 'Lightweight, corrosion-resistant routes for LPBF, EBM, medical, and aerospace programs.',
    accent: '#34d0c5',
  },
  {
    id: 'stainless-steel',
  ...
  },
  {
    ...
    description: 'Powder routes for conformal cooling, tooling inserts, dies, and high-strength production hardware.',
    accent: '#65ab8b',
  },
  {
    id: 'aluminum',
  ...
  },
  {
    id: 'copper-alloy',
    label: 'Copper alloys',
    description: 'Conductive powder routes for thermal, electrical, RF, and high-heat-flux components.',
    accent: '#f07c46',
  },
  {
    id: 'cobalt-chrome',
...
export const products: Product[] = [
  {
    ...
    summary:
      'The primary titanium alloy route for lightweight structural AM parts where strength-to-weight performance matters.',
    ...
    availabilityLabel: 'Confirm by lot',
  ...
  },
  {
    ...
    summary:
      'Extra-low-interstitial titanium route for projects that require tighter chemistry control and qualification evidence.',
    image: '/images/products/titanium.svg',
    accent: '#4ed8ce',
    particleSizes: ['15–45 µm', '15–53 µm', '45–105 µm'],
    processes: ['LPBF', 'EBM'],
  ...
  },
  {
    ...
    summary:
      'Commercially pure titanium route for corrosion-led parts where ductility and chemical compatibility lead the decision.',
  ...
  },
  {
    ...
    summary:
      'Near-alpha titanium powder route for elevated-temperature structural programs and aerospace development work.',
    image: '/images/products/titanium.svg',
    accent: '#27b8aa',
    ...
    availabilityLabel: 'Made to requirement',
    orderLabel: 'Engineering RFQ',
  ...
  },
  {
    ...
    documentOptions: [...commonDocuments, 'Chemistry report'],
    availabilityLabel: 'Regular sourcing route',
  ...
  },
  {
    ...
    summary:
      'Conductive copper-alloy powder route for thermal, electrical, RF, tooling, and high-heat-flux components.',
