...
export const applicationHubs: HubDefinition[] = [
  ...
  },
  {
    ...
    description: 'Nickel, copper, stainless, and titanium powder content for rocket-side, hydrogen, fuel-cell, turbine, combustor, hot-gas, and propulsion-support applications.',
    postIds: [
      'lpbf-metal-powder-defense-sustainment-spares',
      '316l-powder-hydrogen-electrolyzer-flow-field-plates',
      'cucrzr-powder-fusion-high-heat-flux-cooling-components',
  ...
  },
  {
    ...
    description: '17-4PH, Ti64, 316L, CoCrMo, and CuCrZr powder pages for robotic arms, actuator hardware, fixtures, wear parts, and conductive tooling.',
    postIds: [
      'ti64-vs-17-4ph-powder-humanoid-robot-joints',
      '17-4ph-powder-industrial-automation-actuator-housings-and-latch-hardware',
      'ti64-powder-robotic-arm-brackets-and-end-effector-hardware',
  ...
  },
  {
    ...
    description: 'Titanium, 17-4PH, aluminum, and copper powder pages for lightweight robot joints, actuator housings, wrist hardware, sensor payloads, and end-effector support parts.',
    postIds: [
      'ti64-vs-17-4ph-powder-humanoid-robot-joints',
      'ti64-powder-robotic-arm-brackets-and-end-effector-hardware',
      '17-4ph-powder-industrial-automation-actuator-housings-and-latch-hardware',
