...
export const processHubs: HubDefinition[] = [
  ...
  },
  {
    ...
    slug: 'lpbf',
    title: 'LPBF Powder',
    description: 'Find a powder supply route for laser powder bed fusion: choose the alloy grade, review machine-compatible particle size and lot evidence, then send a grade-specific RFQ. Start with Ti6Al4V, 316L or AlSi10Mg below; proposed supply is reviewed against your process and specification.',
    postIds: [
